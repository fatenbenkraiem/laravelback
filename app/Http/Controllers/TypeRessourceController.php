...
class TypeRessourceController extends Controller
{
    ...
    public function addTypeRessource(Request $request)
    {
        ...
        return response()->json(['message' => 'Type Ressources created successfully']);
    }
     /**
    ...
    public function updateTypeRessource(Request $request, $id)
    {
        ...
        // Return success response
        return response()->json(['message' => 'type Ressources updated successfully']);
    }
    ...
    public function deleteTypeRessource($id)
    {
        ...
        // Return success response
        return response()->json(['message' => 'Type Ressources deleted successfully']);
    }
